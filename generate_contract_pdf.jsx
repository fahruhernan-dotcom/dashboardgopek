...
// ══════════════════════════════════════════════════════════════════════════════
// 📝 DATA KONTRAK TERISI LENGKAP
// ══════════════════════════════════════════════════════════════════════════════
export const DATA_KONTRAK = {
  nomorSurat: '001/SPK-GPK/VIII/2026',
  kota: 'Sukoharjo',
  hari: 'Jumat',
  ...
  pihakPertama: {
    nama: 'Fahrurosadi Hernan Sakti',
    namaBrand: 'Ternakos',
    alamat: 'Sukoharjo, Jawa Tengah',
    telepon: '082133859391',
  },

  // ── PIHAK KEDUA (KLIEN / PEMILIK TOKO) ──
  pihakKedua: {
    nama: 'Ilham',
    namaUsaha: 'Gopek Mart',
    alamat: '-',
    telepon: '-',
  },
  ...
  pembayaran: {
    biayaSetup: 'Rp 1.500.000,-',
    biayaBulanan: 'Rp 500.000,-',
    biayaFiturMinor: 'Rp 150.000,- s.d. Rp 200.000,-',
    tglJatuhTempo: '14',
    bank: 'BNI',
    noRekening: '828872449',
    atasNama: 'Fahrurosadi Hernan Sakti',
  },
}
// ══════════════════════════════════════════════════════════════════════════════
  ...
  <Document>
    ...
    <Page size="A4" style={s.page}>
      ...
      <Text style={s.preamble}>
        Pada hari ini, {data.hari} tanggal {data.tanggal}, bertempat di {data.kota}, disepakati perjanjian kerja sama penggunaan dan pengelolaan perangkat lunak Dashboard Gopek (Sistem Distribusi Sembako & Logistik) oleh dan antara pihak-pihak di bawah ini:
      </Text>

      <View style={s.partiesContainer}>
        <View style={s.partyCard}>
          <Text style={s.partyHeader}>PIHAK PERTAMA (PENGEMBANG / TERNAKOS)</Text>
        ...
        <View style={s.partyCard}>
          <Text style={s.partyHeader}>PIHAK KEDUA (KLIEN / GOPEK MART)</Text>
      ...
      <View style={s.pasalBox}>
        ...
        <Text style={s.paragraph}>
          1. <Text style={s.bold}>Penyediaan Sistem Standar:</Text> PIHAK PERTAMA memberikan hak akses dan lisensi penggunaan aplikasi <Text style={s.bold}>Dashboard Gopek</Text> yang mencakup modul-modul fungsional standar saat serah terima:
        </Text>
        <View style={s.bulletList}>
          <View style={s.bulletItem}>
            <Text style={s.bulletDot}>•</Text>
            <Text style={s.bulletText}><Text style={s.bold}>Manajemen Produk & Stok:</Text> Katalog sembako/rokok, konversi multi-satuan (karton, bal besar, bal kecil, slop, pack), stok batch, dan perhitungan HPP terbobot (FIFO).</Text>
          </View>
          <View style={s.bulletItem}>
            <Text style={s.bulletDot}>•</Text>
            <Text style={s.bulletText}><Text style={s.bold}>Penjualan & Kasir:</Text> Pembuatan faktur, kalkulasi margin laba bersih real-time, pencatatan piutang jatuh tempo, saldo deposit, dan sistem retur barang.</Text>
          </View>
          <View style={s.bulletItem}>
            <Text style={s.bulletDot}>•</Text>
            <Text style={s.bulletText}><Text style={s.bold}>Logistik & Armada:</Text> Penugasan supir, kendaraan, dan rincian biaya operasional (Bensin, Rokok Supir, Uang Makan, Tol, Parkir, Bongkar Muat).</Text>
          </View>
          <View style={s.bulletItem}>
            <Text style={s.bulletDot}>•</Text>
            <Text style={s.bulletText}><Text style={s.bold}>Laporan & Dokumen:</Text> Generator invoice resmi, surat jalan pengiriman, cetak thermal/A4, dan rekap keuangan.</Text>
          </View>
          <View style={s.bulletItem}>
            <Text style={s.bulletDot}>•</Text>
            <Text style={s.bulletText}><Text style={s.bold}>Akses Multi-Platform:</Text> Web Dashboard dan Aplikasi Android (Capacitor/PWA).</Text>
          </View>
        </View>
        <Text style={s.paragraph}>
          2. <Text style={s.bold}>Sifat Hak Pakai (Lisensi):</Text> PIHAK KEDUA menerima Hak Pakai Resmi (SaaS License) selama masa berlangganan aktif. Hak cipta kode sumber (source code), arsitektur, dan kekayaan intelektual sistem tetap sepenuhnya milik sah PIHAK PERTAMA (Ternakos).
        </Text>
      </View>
      ...
      <View style={s.pasalBox}>
        ...
        <View style={s.bulletList}>
          <View style={s.bulletItem}>
            ...
            <Text style={s.bulletText}><Text style={s.bold}>Biaya Setup & Konfigurasi Awal (One-Time Fee):</Text> Sebesar <Text style={s.priceHighlight}>{data.pembayaran.biayaSetup} (Satu Juta Lima Ratus Ribu Rupiah)</Text> dibayarkan 1 (satu) kali sebelum akun dan server diserahterimakan.</Text>
          </View>
          <View style={s.bulletItem}>
          ...
          <View style={s.bulletItem}>
            ...
            <Text style={s.bulletText}><Text style={s.bold}>Biaya Pihak Ketiga (Third-Party Services):</Text> Biaya layanan berbayar pihak ketiga di luar paket standar (seperti WA Gateway resmi berbayar, domain kustom pribadi .com) menjadi tanggungan PIHAK KEDUA.</Text>
          </View>
          <View style={s.bulletItem}>
      ...
      <Text style={s.footerText}>Dashboard Gopek • Dokumen Perjanjian Kerja Sama Resmi • Halaman 1 dari 2</Text>
    </Page>
    ...
    <Page size="A4" style={s.page}>
      ...
      {/* PASAL 4 */}
      <View style={s.pasalBox}>
        <Text style={s.pasalTitle}>PASAL 4: PENAMBAHAN FITUR MINOR (RP 150.000 – RP 200.000) VS MODUL BESAR</Text>
        <View style={s.bulletList}>
          <View style={s.bulletItem}>
            <Text style={s.bulletDot}>•</Text>
            <Text style={s.bulletText}><Text style={s.bold}>Tingkat Ringan (Rp 150.000,- / permintaan):</Text> Penyesuaian tata letak nota, penambahan tombol shortcut, perubahan label/warna status, filter data sederhana (estimasi pengerjaan &lt; 1 hari).</Text>
          </View>
          <View style={s.bulletItem}>
            <Text style={s.bulletDot}>•</Text>
            <Text style={s.bulletText}><Text style={s.bold}>Tingkat Sedang (Rp 200.000,- / permintaan):</Text> Penambahan kolom data baru ke database, penyesuaian rumus diskon/margin, validasi form, modifikasi alur pengiriman (estimasi 1–2 hari kerja).</Text>
          </View>
          <View style={s.bulletItem}>
            <Text style={s.bulletDot}>•</Text>
      ...
      <View style={s.pasalBox}>
        ...
        <Text style={s.paragraph}>
          2. <Text style={s.bold}>Kepemilikan Data:</Text> Seluruh data transaksi, pelanggan, dan keuangan adalah 100% milik mutlak PIHAK KEDUA (Gopek Mart).
        </Text>
        <Text style={s.paragraph}>
      ...
      <View style={s.signSection}>
        ...
        <View style={s.signRow}>
          <View style={s.signBox}>
            ...
            <Text style={s.signSub}>Pengembang / Ternakos</Text>
          ...
          <View style={s.signBox}>
            ...
            <Text style={s.signSub}>Klien / Gopek Mart</Text>
            <View style={s.meteraiBox}>
              <Text style={s.meteraiText}>METERAI</Text>
              <Text style={s.meteraiText}>Rp 10.000</Text>
            </View>
      ...
      <Text style={s.footerText}>Dashboard Gopek • Dokumen Perjanjian Kerja Sama Resmi • Halaman 2 dari 2</Text>
    </Page>
  </Document>
)

async function generatePDF() {
  const outputPath = path.join(__dirname, 'KONTRAK_LAYANAN_GOPEK.pdf')
