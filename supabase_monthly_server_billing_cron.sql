...
BEGIN
    ...
    IF v_days_left = 7 THEN
        ...
        v_body := 'Tagihan langganan server Gopek akan jatuh tempo pada 28 ' || v_month_name || '. Mohon persiapkan pembayaran tepat waktu.';
    ...
    ELSIF v_days_left = 4 THEN
        ...
        v_body := '4 hari lagi batas waktu pembayaran server toko Gopek (28 ' || v_month_name || ').';
