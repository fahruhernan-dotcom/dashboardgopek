...
import { CheckCircle2, Truck, Fuel, Utensils, Cigarette, CircleParking, Package, AlertCircle, Loader2 } from 'lucide-react'
...
const PRESET_CATEGORIES = [
  { id: 'bensin', label: 'Bensin', icon: Fuel, color: '#3B82F6', bg: '#EFF6FF', border: '#BFDBFE' },
  { id: 'rokok', label: 'Rokok Sopir', icon: Cigarette, color: '#F59E0B', bg: '#FFFBEB', border: '#FDE68A' },
  { id: 'makan', label: 'Uang Makan', icon: Utensils, color: '#10B981', bg: '#F0FDF4', border: '#BBF7D0' },
      ...
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          ...
          >
            ...
            <span style={{ fontSize: 10, opacity: 0.8, fontWeight: 600 }}>Bensin / Rokok / Makan</span>
          </button>
        </div>
      </div>
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                placeholder="Contoh: Isi bensin pertalite 50rb + rokok sopir 25rb"
                style={{
                  width: '100%',
                  background: '#FFFFFF',
