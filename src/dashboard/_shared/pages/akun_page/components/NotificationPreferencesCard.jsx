    ...
    try {
      const { data, error } = await supabase.functions.invoke('send-push-notification', {
        body: {
          ...
          body: 'Notifikasi Android Dashboard Gopek berfungsi 100% normal!',
          data: { route: '/akun' }
        }
      })
      ...
      try {
        await supabase.rpc('dispatch_tenant_notification', {
          ...
          p_type: 'SYSTEM_ALERT',
          p_title: '🔔 Tes Notifikasi Gopek',
          p_body: 'Notifikasi sistem Android Dashboard Gopek berhasil terhubung!',
          p_data: { route: '/akun' }
        })
