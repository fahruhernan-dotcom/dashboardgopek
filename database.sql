-- =============================================================================
-- GOPEK DISTRIBUTOR ROKOK - SUPABASE DATABASE MIGRATION SCRIPT
-- Description: Complete schema for Retur Produk Rokok (sembako_returns) & FIFO batch tracking
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS public.sembako_returns (
  ...
  unit VARCHAR(32) NOT NULL DEFAULT 'slop',
  unit_price NUMERIC(15, 2) DEFAULT 0,
  total_amount NUMERIC(15, 2) DEFAULT 0,
  reason VARCHAR(255) DEFAULT 'Pita Cukai Cacat',
